...
public class AnalyseCves {
	...
	private static String dumpDir = Konfig.CveSubsetFolder;
	private static String cveFolder = Konfig.CveFolder;
	private static String dataType = Konfig.Datatype;
	private static String analysisResultFile = Konfig.CvePrint;
	private static boolean testmode = Konfig.Testmode;
	private static int messageTime = Konfig.MessageTime;
				...
				if (f.isDirectory()) {
					...
					if (!year.equals(fileYear)) {
						...
						bw = new BufferedWriter(new FileWriter(new File(
								Konfig.outputFolder, "nvdcve-2.0-" + year
										+ "-enhanced.xml")));
