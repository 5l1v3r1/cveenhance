...
public class AnalyseTest {
	...
	public void beforeKeywordTest(){
		try {
			...
			testItems[0] = new CveItem(intoString+"<vuln:product>cpe:/a:macromedia:flashplayer:7.2</vuln:product>"+secondString+"CVE-2000-0000"+thirdString+"In the Macromedia Flash Player before 7.3 a cross side vunerability occours. It is often used to gather bank account data. "+lastString);
	...
	public void beforeAndEarlierTest(){
		try {
			...
			testItems[0] = new CveItem(intoString+"<vuln:product>cpe:/a:macromedia:flashplayer:7.2</vuln:product>"+secondString+"CVE-2000-0000"+thirdString+"In the Macromedia Flash Player 7.2.3 and earlier before 7.2.4 a cross side vunerability occours. It is often used to gather bank account data. "+lastString);
	...
	public void multiSoftwareTest(){
		try {
			testItems[2] = new CveItem(intoString+"<vuln:product>cpe:/a:adobe:flashplayer:4.3.0</vuln:product><vuln:product>cpe:/a:adobe:flashplayer:4.3.1</vuln:product><vuln:product>cpe:/a:macromedia:flashplayer:7.1</vuln:product><vuln:product>cpe:/a:macromedia:flashplayer:7.2</vuln:product><vuln:product>cpe:/a:macromedia:flashplayer:7.0</vuln:product>"+secondString+"CVE-2000-0002"+thirdString+"In the Macromedia Flash Player 7.2 and earlier and Adobe Flash Player before 4.3.2 a cross side vunerability occours. It is often used to gather bank account data. "+lastString);
	...
	public void multiVersionTest1(){
		try {
			testItems[3] = new CveItem(intoString+"<vuln:product>cpe:/a:macromedia:flashplayer:7.2.3</vuln:product><vuln:product>cpe:/a:macromedia:flashplayer:7.2.4</vuln:product><vuln:product>cpe:/a:macromedia:flashplayer:7.2.7</vuln:product><vuln:product>cpe:/a:macromedia:flashplayer:8.3.3</vuln:product><vuln:product>cpe:/a:macromedia:flashplayer:8.3.2</vuln:product>"+secondString+"CVE-2000-0003"+thirdString+"In the Macromedia Flash Player 7.2 before 7.2.8 and in 8.3.x before 8.3.4 a cross side vunerability occours. It is often used to gather bank account data. "+lastString);
	...
	public void versionRangeRecognitionTest(){
		try {
			testItems[6] = new CveItem(intoString+"<vuln:product>cpe:/a:mozilla:softwaretestsuite:3.2.1</vuln:product><vuln:product>cpe:/a:mozilla:softwaretestsuite:3.2.2</vuln:product><vuln:product>cpe:/a:mozilla:softwaretestsuite:3.2.3</vuln:product><vuln:product>cpe:/a:mozilla:softwaretestsuite:4.2.4</vuln:product><vuln:product>cpe:/a:mozilla:softwaretestsuite:4.2.3</vuln:product>"+secondString+"CVE-2000-0005"+thirdString+"In the Multimedia Center of the Mozilla Software Testsuite 3.2.1, 3.2.2 and 3.2.3 update 2 a cross CSS attack is possible. It is often used to gather you personal Backgammon Arcade game data. "+lastString);
			addPartResult("Mozilla Software Testsuite", "3.2.1", "3.2.1", "", "cpe:/a:mozilla:softwaretestsuite:", "CVE-2000-0005");
			addPartResult("Mozilla Software Testsuite", "3.2.2", "3.2.2", "", "cpe:/a:mozilla:softwaretestsuite:", "CVE-2000-0005");
			addPartResult("Mozilla Software Testsuite", "3.2.3 update 2", "3.2.3 update 2", "", "cpe:/a:mozilla:softwaretestsuite:", "CVE-2000-0005");
	...
	public void softwareNameRecognitionTest(){
		try {
			testItems[7] = new CveItem(intoString+"<vuln:product>cpe:/a:mozilla:softwaretestsuite:3.2.1</vuln:product><vuln:product>cpe:/a:adobe:reader:7.3</vuln:product><vuln:product>cpe:/a:mozilla:softwaretestsuite:3.2.0</vuln:product><vuln:product>cpe:/a:mozilla:firefox:3.2.3</vuln:product><vuln:product>cpe:/a:mozilla:firefox:3.2.2</vuln:product>"+secondString+"CVE-2000-0006"+thirdString+"In Mozilla Software Testsuite 3.2.1, Adobe Reader, Mozilla Firefox 3.2.2 and 3.2.3 and a cross CSS attack is possible. It is often used to gather you personal Backgammon Arcade game data. "+lastString);
